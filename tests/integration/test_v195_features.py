...
Verifies:
- docs/api-stability.md version header updated to v1.9.3
- docs/error-catalog.md version header updated to v1.9.3
...
class TestV195DocNormalization:
    ...
    def test_all_doc_headers_current(self) -> None:
        """All user-facing doc headers should reference v1.9.3, not older versions."""
